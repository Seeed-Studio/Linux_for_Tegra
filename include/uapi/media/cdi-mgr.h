...
#define CDI_MGR_IOCTL_GPIO_GET_LEVEL \
	_IOWR('o',  18, struct cdi_mgr_gpio_level)
#define CDI_MGR_IOCTL_GPIO_SET_LEVEL \
	_IOW('o',  19, struct cdi_mgr_gpio_level)
...
enum {
	CDI_MGR_GPIO_LEVEL_LOW = 0,
	CDI_MGR_GPIO_LEVEL_HIGH,
};

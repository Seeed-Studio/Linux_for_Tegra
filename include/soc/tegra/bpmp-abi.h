...
struct mrq_request {
	 ...
	 * builds for the T234 and T239 -platforms:
	 *
	 * | MRQ             | Sub-command                  | Minimum payload length                              |
	 * | ----------------| -----------------------------| --------------------------------------------------- |
	 ...
	 *
	 * @cond bpmp_t239
	 * The following additional MRQs are supported on T239 platform:
	 *
	 * | MRQ            | Sub-command                       | Minimum payload length |
	 * | ---------------| ----------------------------------| ---------------------- |
	 ...
	 *
	 * @cond (bpmp_t264)
	 * The following additional MRQs are supported on T264 -platform:
	 *
	 * | MRQ            | Sub-command                       | Minimum payload length |
	 * | ---------------| ----------------------------------| ---------------------- |
...
struct cmd_pg_get_state_response {
	 ...
	 * succesfully requested by the master earlier using #MRQ_PG
 ...
 *
 * * Platforms: TH500, T239
 * @cond (bpmp_th500 || bpmp_t239)
 * * Initiators: CCPLEX
 * * Targets: BPMP
 ...
 *
 * @cond bpmp_t239
 * The following additional sub-commands are supported on T239 platforms:
 * | Sub-command                        | Request payload                     |
 * |------------------------------------|-------------------------------------|
...
//adoc: tag::bpmp_dmce_mrq_shutdown_info[]
/**
 * @ingroup MRQ_Codes
 * @def MRQ_SHUTDOWN
...
/** @} Shutdown */
//adoc: end::bpmp_dmce_mrq_shutdown_info[]

...
#define REGULATION_CHPLAN_VERSION 66
...
const struct country_domain_mapping cdmap[] = {
    ...
    {0x11, 0x00, {'B', 'O'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0001 */
    {0x62, 0x05, {'B', 'R'}, TPO_NA, 0x0f, 0, 0x01, 0}, /* 0002 */
    {0x76, 0x01, {'C', 'L'}, TPO_CHILE, 0x0f, 0, 0x05, 0}, /* 0003 */
    ...
    {0x76, 0x05, {'G', 'U'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0165 */
    ...
    {0x76, 0x05, {'M', 'H'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0185 */
    ...
    {0x76, 0x05, {'F', 'M'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0190 */
    ...
    {0x76, 0x05, {'M', 'P'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0200 */
    {0x76, 0x05, {'P', 'W'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0201 */
    ...
    {0x76, 0x05, {'M', 'F'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0207 */
    {0x76, 0x05, {'S', 'X'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0208 */
    ...
    {0x76, 0x05, {'V', 'I'}, TPO_NA, 0x0f, 0, 0x03, 1}, /* 0231 */

...
/*
 * rtw_hal_get_wpaddr_sel_num - query the number of wp addr high selection
 *
 * query the number of wp addr high selection
 */
void rtw_hal_get_wpaddr_sel_num(void *hal, u32 *val);

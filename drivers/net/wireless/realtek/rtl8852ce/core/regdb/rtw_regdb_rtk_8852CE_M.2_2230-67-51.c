...
#define RTW_MODULE_NAME		"8852CE_M.2_2230"
#define RTW_DOMAIN_MAP_VER	"67"
#define RTW_DOMAIN_MAP_M_VER	""
#define RTW_COUNTRY_MAP_VER	"51"
...
static const struct country_chplan country_chplan_map[] = {
	...
	COUNTRY_CHPLAN_ENT("AF", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Afghanistan */
	COUNTRY_CHPLAN_ENT("AG", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Antigua & Barbuda */
	COUNTRY_CHPLAN_ENT("AI", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Anguilla(UK) */
	...
	COUNTRY_CHPLAN_ENT("AS", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* American Samoa */
	COUNTRY_CHPLAN_ENT("AT", 0x5E, 0x06, DEF     , 1, 1, 1, 1, _IV), /* Austria */
	COUNTRY_CHPLAN_ENT("AU", 0x03, 0x1B, DEF     , 1, 1, 1, 1, _IV), /* Australia */
	COUNTRY_CHPLAN_ENT("AW", 0x76, 0x00, DEF     , 0, 1, 1, 1, ___), /* Aruba */
	...
	COUNTRY_CHPLAN_ENT("BO", 0x11, 0x00, DEF     , 0, 1, 1, 1, _I_), /* Bolivia */
	COUNTRY_CHPLAN_ENT("BR", 0x62, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Brazil */
	COUNTRY_CHPLAN_ENT("BS", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Bahamas */
	COUNTRY_CHPLAN_ENT("BT", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Bhutan */
	...
	COUNTRY_CHPLAN_ENT("BY", 0x0A, 0x00, DEF     , 0, 0, 1, 1, ___), /* Belarus */
	...
	COUNTRY_CHPLAN_ENT("CD", 0x5E, 0x00, DEF     , 1, 1, 1, 1, ___), /* Congo, Republic of the */
	...
	COUNTRY_CHPLAN_ENT("CL", 0x76, 0x01, CHILE   , 1, 1, 1, 1, _I_), /* Chile */
	COUNTRY_CHPLAN_ENT("CM", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Cameroon */
	COUNTRY_CHPLAN_ENT("CN", 0x06, 0x00, CN      , 0, 1, 1, 1, ___), /* China */
	...
	COUNTRY_CHPLAN_ENT("FM", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Micronesia, Federated States of (USA) */
	...
	COUNTRY_CHPLAN_ENT("GE", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Georgia */
	...
	COUNTRY_CHPLAN_ENT("GI", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Gibraltar (UK) */
	...
	COUNTRY_CHPLAN_ENT("GU", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Guam (USA) */
	...
	COUNTRY_CHPLAN_ENT("IQ", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Iraq */
	COUNTRY_CHPLAN_ENT("IR", 0x0A, 0x00, DEF     , 0, 0, 0, 0, ___), /* Iran */
	...
	COUNTRY_CHPLAN_ENT("KI", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Kiribati */
	...
	COUNTRY_CHPLAN_ENT("KY", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Cayman Islands (UK) */
	...
	COUNTRY_CHPLAN_ENT("LS", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Lesotho */
	...
	COUNTRY_CHPLAN_ENT("LY", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Libya */
	...
	COUNTRY_CHPLAN_ENT("MF", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Saint Martin */
	COUNTRY_CHPLAN_ENT("MG", 0x5E, 0x06, DEF     , 1, 1, 1, 1, _I_), /* Madagascar */
	COUNTRY_CHPLAN_ENT("MH", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Marshall Islands (USA) */
	...
	COUNTRY_CHPLAN_ENT("MP", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Northern Mariana Islands (USA) */
	...
	COUNTRY_CHPLAN_ENT("PW", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Palau */
	...
	COUNTRY_CHPLAN_ENT("RU", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Russia(fac/gost), Kaliningrad */
	COUNTRY_CHPLAN_ENT("RW", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Rwanda */
	COUNTRY_CHPLAN_ENT("SA", 0x5E, 0x06, DEF     , 1, 1, 1, 1, _I_), /* Saudi Arabia */
	COUNTRY_CHPLAN_ENT("SB", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Solomon Islands */
	...
	COUNTRY_CHPLAN_ENT("SO", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Somalia */
	...
	COUNTRY_CHPLAN_ENT("SX", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* Sint Marteen */
	COUNTRY_CHPLAN_ENT("SZ", 0x5E, 0x00, DEF     , 0, 1, 1, 1, ___), /* Swaziland */
	COUNTRY_CHPLAN_ENT("TC", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Turks and Caicos Islands (UK) */
	...
	COUNTRY_CHPLAN_ENT("TO", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Tonga */
	...
	COUNTRY_CHPLAN_ENT("VC", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Saint Vincent and the Grenadines */
	COUNTRY_CHPLAN_ENT("VE", 0x30, 0x00, DEF     , 0, 1, 1, 1, ___), /* Venezuela */
	COUNTRY_CHPLAN_ENT("VG", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* British Virgin Islands (UK) */
	COUNTRY_CHPLAN_ENT("VI", 0x76, 0x05, DEF     , 1, 1, 1, 1, _I_), /* United States Virgin Islands (USA) */
	...
	COUNTRY_CHPLAN_ENT("WS", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Samoa */
	COUNTRY_CHPLAN_ENT("XK", 0x5E, 0x06, DEF     , 1, 1, 1, 1, _I_), /* Kosovo */
	COUNTRY_CHPLAN_ENT("YE", 0x0A, 0x00, DEF     , 0, 1, 1, 1, ___), /* Yemen */
	...
	COUNTRY_CHPLAN_ENT("ZW", 0x5E, 0x00, DEF     , 1, 1, 1, 1, ___), /* Zimbabwe */
};

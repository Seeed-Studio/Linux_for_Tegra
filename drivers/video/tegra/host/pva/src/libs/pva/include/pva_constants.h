...
#define PVA_MAX_NUM_SMMU_CONTEXTS 10

#define PVA_NUM_SMMU_CONTEXTS_T23X 9
#define PVA_NUM_SMMU_CONTEXTS_T26X 10

#define PVA_MAX_NUM_USER_CONTEXTS 7u

#define PVA_R5_SMMU_CONTEXT_ID 0

#define TIME_MS_TO_NS 1000000U
#define TIME_MS_TO_US 1000U
#define TIME_US_TO_NS 1000U
#define TIME_US_TO_MS 1000U

#define PVA_PRIV_CCQ_ID 0
#define PVA_INVALID_QUEUE_ID 0xFF

#define PVA_MAX_NUM_CHUNKS_PER_CONTEXT 128
#define PVA_MAX_NUM_SUBMIT 256

#define PVA_MAX_NUM_PVAS 1
#define PVA_NUM_PVE 2

#define PVA_MAX_NUM_RESETS 1
#define PVA_MAX_NUM_CLOCKS 3

#define PVA_MAX_NUM_QUEUES_PER_CONTEXT 8u
#define PVA_NUM_RW_SYNCPTS_PER_CONTEXT PVA_MAX_NUM_QUEUES_PER_CONTEXT

#define PVA_MAX_NUM_DMA_CONFIGS_PER_CONTEXT 1024

#define PVA_MAX_NUM_SEMAPHORES 1024

#define MAX_BYTES_PER_PIXEL 0x3U

#define PVA_NUM_DMA_TRIGGERS 9
...
#define PVA_BL_XBAR_RAW 1
#define PVA_BL_TEGRA_RAW 0
#define PVA_BL_SECTOR_PACK_BIT_SHIFT 39

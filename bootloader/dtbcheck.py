...
def __check_root_t194(node):
    # BPMPDTB-ROOT-1
    __check_props(node)

def __check_root_t264(node):
    # BPMPDTB-ROOT-1
    __check_props(node)

def __check_root_tb500(node):
    # BPMPDTB-ROOT-1
    __check_props(node)
...
def __main():
    ...
    root_rules = {
        't194':
        FdtRule('', __check_root_t194, subrules=[
        ]),
        't234':
        ...
        't264':
        FdtRule('', __check_root_t264, subrules=[
        ]),
        't268':
        FdtRule('', __check_root_t264, subrules=[
        ]),
        'tb500':
        FdtRule('', __check_root_tb500, subrules=[
        ]),
    }

...
### Since JP6.1 from seeed. We can trace the source of a specific firmware.
#### Here is a example:
```
...
```
#### It shows the firmware name which included this rootfs is `mfi_recomputer-orin-nx-8g-j401-6.1-36.4.0-2024-12-04.tar.gz`. 
#### The code branch name is `R36.4.0`.
#### the commit hash is `970b38cf3ccaf8ca57ca3a889acd91dc153e464b`.

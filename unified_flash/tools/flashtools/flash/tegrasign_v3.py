...
def parse_cmdline(commandLine):
    ...
    parser.add_argument("--pubkeyhash", help="Specify the files to save public key and hash. \
        ...
        2) <public key> <hash file> <rsa|eddsa|ecdsa|xmss> when --key <private key> is not used.\
            Note in this case the public key is specific format and the key type flag is required", metavar='FILE', nargs='*')

...
#define RTW_MODULE_NAME		"8851BE_M.2_2230"
#define RTW_DOMAIN_MAP_VER	"67"
#define RTW_DOMAIN_MAP_M_VER	""
#define RTW_COUNTRY_MAP_VER	"3"
...
static const struct country_chplan country_chplan_map[] = {
	...
	COUNTRY_CHPLAN_ENT("AF", 0x0A, 0x00, DEF     , 1, 1, 1), /* Afghanistan */
	...
	COUNTRY_CHPLAN_ENT("AQ", 0x3A, 0x00, DEF     , 1, 1, 1), /* Antarctica */
	COUNTRY_CHPLAN_ENT("AR", 0x4D, 0x00, DEF     , 1, 1, 1), /* Argentina */
	COUNTRY_CHPLAN_ENT("AS", 0x0A, 0x00, DEF     , 1, 1, 1), /* American Samoa */
	...
	COUNTRY_CHPLAN_ENT("DJ", 0x5E, 0x00, DEF     , 1, 1, 1), /* Djibouti */
	...
	COUNTRY_CHPLAN_ENT("ER", 0x0A, 0x00, DEF     , 1, 1, 1), /* Eritrea */
	...
	COUNTRY_CHPLAN_ENT("GB", 0x0B, 0x00, UK      , 1, 1, 1), /* Great Britain (United Kingdom; England) */
	...
	COUNTRY_CHPLAN_ENT("HN", 0x76, 0x00, DEF     , 1, 1, 1), /* Honduras */
	...
	COUNTRY_CHPLAN_ENT("IQ", 0x0A, 0x00, DEF     , 1, 1, 1), /* Iraq */
	COUNTRY_CHPLAN_ENT("IR", 0x0A, 0x00, DEF     , 0, 0, 0), /* Iran */
	...
	COUNTRY_CHPLAN_ENT("JO", 0x5E, 0x00, DEF     , 1, 1, 1), /* Jordan */
	...
	COUNTRY_CHPLAN_ENT("KI", 0x0A, 0x00, DEF     , 1, 1, 1), /* Kiribati */
	COUNTRY_CHPLAN_ENT("KM", 0x5E, 0x00, DEF     , 1, 1, 1), /* Comoros */
	...
	COUNTRY_CHPLAN_ENT("KY", 0x0A, 0x00, DEF     , 1, 1, 1), /* Cayman Islands (UK) */
	...
	COUNTRY_CHPLAN_ENT("LY", 0x0A, 0x00, DEF     , 1, 1, 1), /* Libya */
	...
	COUNTRY_CHPLAN_ENT("RU", 0x0A, 0x00, DEF     , 1, 1, 1), /* Russia(fac/gost), Kaliningrad */
	COUNTRY_CHPLAN_ENT("RW", 0x5E, 0x00, DEF     , 1, 1, 1), /* Rwanda */
	COUNTRY_CHPLAN_ENT("SA", 0x5E, 0x00, DEF     , 1, 1, 1), /* Saudi Arabia */
	COUNTRY_CHPLAN_ENT("SB", 0x0A, 0x00, DEF     , 1, 1, 1), /* Solomon Islands */
	...
	COUNTRY_CHPLAN_ENT("SO", 0x0A, 0x00, DEF     , 1, 1, 1), /* Somalia */
	...
	COUNTRY_CHPLAN_ENT("TC", 0x0A, 0x00, DEF     , 1, 1, 1), /* Turks and Caicos Islands (UK) */
	...
	COUNTRY_CHPLAN_ENT("TO", 0x0A, 0x00, DEF     , 1, 1, 1), /* Tonga */
	...
	COUNTRY_CHPLAN_ENT("US", 0x1B, 0x00, DEF     , 1, 1, 1), /* United States of America (USA) */
	COUNTRY_CHPLAN_ENT("UY", 0x30, 0x00, DEF     , 1, 1, 1), /* Uruguay */
	COUNTRY_CHPLAN_ENT("UZ", 0x3A, 0x00, DEF     , 1, 1, 1), /* Uzbekistan */
	COUNTRY_CHPLAN_ENT("VA", 0x5E, 0x00, DEF     , 1, 1, 1), /* Holy See (Vatican City) */
	COUNTRY_CHPLAN_ENT("VC", 0x0A, 0x00, DEF     , 1, 1, 1), /* Saint Vincent and the Grenadines */
	COUNTRY_CHPLAN_ENT("VE", 0x30, 0x00, DEF     , 1, 1, 1), /* Venezuela */
	COUNTRY_CHPLAN_ENT("VG", 0x0A, 0x00, DEF     , 1, 1, 1), /* British Virgin Islands (UK) */
	...
	COUNTRY_CHPLAN_ENT("VU", 0x3A, 0x00, DEF     , 1, 1, 1), /* Vanuatu */
	COUNTRY_CHPLAN_ENT("WF", 0x3A, 0x00, DEF     , 1, 1, 1), /* Wallis and Futuna (France) */
	COUNTRY_CHPLAN_ENT("WS", 0x0A, 0x00, DEF     , 1, 1, 1), /* Samoa */
	COUNTRY_CHPLAN_ENT("XK", 0x5E, 0x00, DEF     , 1, 1, 1), /* Kosovo */
	COUNTRY_CHPLAN_ENT("YE", 0x0A, 0x00, DEF     , 1, 1, 1), /* Yemen */

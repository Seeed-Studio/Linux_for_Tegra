...
#define HOST1X_EMU_SYNCPT_IOCTL_CTRL_SYNCPT_LEGACY_INCR		\
	_IOW(HOST1X_EMU_SYNCPT_IOCTL_MAGIC, 5,  struct host1x_emu_ctrl_syncpt_incr_args)

#define HOST1X_EMU_SYNCPT_IOCTL_CTRL_SYNCPT_WAIT		\
	_IOW(HOST1X_EMU_SYNCPT_IOCTL_MAGIC, 6, struct host1x_emu_ctrl_syncpt_wait_args)

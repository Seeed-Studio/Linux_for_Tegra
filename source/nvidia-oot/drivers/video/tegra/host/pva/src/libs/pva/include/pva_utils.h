...
/* Convert volatile pointer to non-volatile void pointer
 * (MISRA C-2023 Rule 11.8 compliant - uses union instead of cast)
 */
static inline void *pva_volatile_ptr_to_void_ptr(void volatile *vol_ptr)
{
	union {
		void volatile *vol;
		void *ptr;

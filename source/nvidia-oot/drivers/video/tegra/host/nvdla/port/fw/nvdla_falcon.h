...
#ifndef _NVDLA_PORT_FW_FALCON_H_
#define _NVDLA_PORT_FW_FALCON_H_

#include <linux/types.h>
#include <linux/platform_device.h>

/* Forward declaration for nvhost_device_data */

...
#define FIRMWARE_T25X_V2_VERSION_MAJOR		((uint32_t)0x3U)
#define FIRMWARE_T25X_V2_VERSION_MINOR		((uint32_t)0x1U)
#define FIRMWARE_T25X_V2_VERSION_SUBMINOR	((uint32_t)0x0U)

...
/* i2c read from device.
   ...
   Note: This function assumes the caller has acquired the cdi mutex
   to ensure thread-safe access to the I2C bus and device registers.
*/
int cdi_dev_raw_rd(

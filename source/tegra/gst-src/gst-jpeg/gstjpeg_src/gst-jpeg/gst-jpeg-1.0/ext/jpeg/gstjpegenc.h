...
typedef struct _GstJpegEnc GstNvJpegEnc;
typedef struct _GstJpegEncClass GstNvJpegEncClass;

#define GstJpegEnc GstNvJpegEnc
#define GstJpegEncClass GstNvJpegEncClass

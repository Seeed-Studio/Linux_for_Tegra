  ...
  g_object_class_install_property (gobject_class, PROP_GPU_DEVICE_ID,
      g_param_spec_uint ("gpu-id", "Set GPU Device ID for operation",
          ...
          (GParamFlags) (G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS |
              GST_PARAM_MUTABLE_READY)));
#elif defined (USE_TARGET_TEGRA)
  g_object_class_install_property (gobject_class, PROP_MJPEG_DECODE,
          g_param_spec_boolean ("mjpegdecode",
              "Enable mjpeg decode",
    ...
    const GValue * value, GParamSpec * pspec)
{
  ...
  switch (prop_id) {
    ...
    case PROP_GPU_DEVICE_ID:
      ...
      break;
#elif defined (USE_TARGET_TEGRA)
    case PROP_MJPEG_DECODE:
      dec->cinfo.mjpeg_decode = g_value_get_boolean (value);
      break;
#endif
...
#elif defined (USE_TARGET_TEGRA)
    case PROP_MJPEG_DECODE:
      g_value_set_boolean (value, dec->cinfo.mjpeg_decode);
      break;
#endif
